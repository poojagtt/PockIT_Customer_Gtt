...
const FilterModal: FC<FilterModalProps> = ({visible, onClose, onSelect}) => {
    ...
    <Modal
      ...
      <View
        ...
        <TouchableOpacity
          ...
          onPress={onClose}
          accessibilityLabel={t('shop.filter.close')}>
          <Icon name="close" type="Ionicons" size={24} color={colors.text} />
        </TouchableOpacity>
        <FlatList
          data={filters}
